  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary/10 via-background to-primary/10 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute top-20 right-10 w-32 h-32 rounded-full bg-secondary/20 blur-xl"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.7, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-20 left-10 w-40 h-40 rounded-full bg-accent/20 blur-xl"
          animate={{
            scale: [1.1, 1, 1.1],
            opacity: [0.4, 0.6, 0.4],
          }}
          ...
          <Card className="shadow-2xl border-0 bg-card/95 backdrop-blur">
            <CardHeader className="text-center pb-2">
              ...
              <CardTitle className="text-2xl font-bold" style={{ fontFamily: "var(--font-playfair)" }}>
                Join <span className="text-primary">Chick Pick</span>
              </CardTitle>
